package com.bfa.faresms.web.rest;

import com.codahale.metrics.annotation.Timed;
import com.bfa.faresms.service.FaresService;
import com.bfa.faresms.web.rest.util.HeaderUtil;
import com.bfa.faresms.web.rest.util.PaginationUtil;
...
public class FaresResource {
    ...
    @GetMapping("/fares")
    @Timed
    public ResponseEntity<List<FaresDTO>> getAllFares(@ApiParam Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of Fares");
        Page<FaresDTO> page = faresService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/fares");
