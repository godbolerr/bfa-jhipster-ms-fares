package com.bfa.faresms.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "faresms@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "faresms API";

        private String description = "faresms API documentation";
