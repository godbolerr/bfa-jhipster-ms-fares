...
import com.bfa.faresms.FaresmsApp;

import com.bfa.faresms.config.SecurityBeanOverrideConfiguration;
...
@SpringBootTest(classes = {FaresmsApp.class, SecurityBeanOverrideConfiguration.class})
